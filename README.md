...
- [Открытый сэмпл](https://nc.cloud.cpur.ru/s/eBHwoyiWGyc5ytB) в виде единого csv-файла (архив: 650 Мб, файл: ~6.5 Гб) или в виде csv-файлов, разбитых по федеральным округам (архив: 650 Мб, файлы: от 300 Мб до 1.7 Гб). Для того, чтобы скачать архив, нужно перейти по ссылке, ввести пароль и выбрать файл для скачивания. В csv исползуется точка с запятой в качестве разделителя, кодировка - UTF-8. ***Пароль для скачивания выслан отдельно***.
- 
